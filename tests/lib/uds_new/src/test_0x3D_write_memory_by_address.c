...
ZTEST_F(lib_uds_new, test_0x3D_write_memory_by_address_valid_memory) {
	...
	uint8_t dest[16] = {0};
	const uint8_t src[16] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06,
...
ZTEST_F(lib_uds_new, test_0x3D_write_memory_by_address_nucleo_ram_out_of_bounds) {
	struct uds_new_instance_t *instance = fixture->instance;
...
ZTEST_F(lib_uds_new, test_0x3D_write_memory_by_address_nucleo_flash_not_writeable) {
	struct uds_new_instance_t *instance = fixture->instance;
...
ZTEST_F(lib_uds_new, test_0x3D_write_memory_by_address_nucleo_flash_out_of_bounds) {
	struct uds_new_instance_t *instance = fixture->instance;
...
ZTEST_F(lib_uds_new, test_0x3D_write_memory_by_address_nucleo_invalid_peripheral) {
	struct uds_new_instance_t *instance = fixture->instance;
...
ZTEST_F(lib_uds_new, test_0x3D_write_memory_by_address_nucleo_invalid_low_memory) {
	struct uds_new_instance_t *instance = fixture->instance;
