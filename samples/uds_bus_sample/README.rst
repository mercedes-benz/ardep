...
For this, each client contains a "controller responder" functionality that listens for CAN frames on a specifig address (configurable via data identifier 0x1100) and responds (with the appended signature byte) on another configurable address (data identifier 0x1101).
